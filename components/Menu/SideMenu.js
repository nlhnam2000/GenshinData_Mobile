...
export const SideMenu = props => {
  return (
    <DrawerContentScrollView {...props} style={{backgroundColor: colors.background, paddingHorizontal: 10}}>
      <View style={styles.menuWrapper}>
        ...
        />
        <DrawerItem label={'Tier list'} labelStyle={{color: 'white', fontWeight: '600', fontSize: 18}} />
        <DrawerItem
          label={'Todo'}
          labelStyle={{color: 'white', fontWeight: '600', fontSize: 18}}
        ...
        />
        <DrawerItem
          label={'Sync with Hoyolab'}
          labelStyle={{color: 'white', fontWeight: '600', fontSize: 18}}
          onPress={() => props.navigation.navigate('Hoyolab')}
        />
      </View>
